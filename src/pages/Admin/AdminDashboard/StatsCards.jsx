  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
      {statCards.map((card, index) => {
        ...
        return (
          <div key={index} className={`bg-white rounded-2xl shadow-lg p-6 border-l-4 ${colorClasses.border}`}>
            ...
            <div className="mt-4 flex items-center text-sm" style={{ color: colorClasses.text }}>
              {card.trendIcon}
              {card.description}
            </div>
          </div>
